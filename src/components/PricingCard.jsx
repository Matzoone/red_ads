...
const PricingCard = ({ title, type, price, features }) => {
  return (
    <div className="bg-white shadow-lg rounded-3xl p-6 my-6 w-full max-w-lg  max-lg:max-w-80 max-md:max-w-64 m-auto transform transition duration-300 hover:-translate-y-3 ">
      {/* برچسب */}
      ...
      <div className="text-center w-full">
        ...
        <div className="w-full flex justify-end">
          <p className="text-sm font-extrabold text-gray-400 mt-2 line-through">
            {price} تومان
          </p>
        </div>
        <div className="w-full flex justify-end">
